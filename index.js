...
var MySQLEvents = function (dsn) {
  var mySQLEvents =  {
      ...
      connect: function (dsn) {
          if (
               !_underScore.isUndefined(dsn.host) &&
              ...
              if (! this.started) {
                  ...
                  this.zongji.on('binlog', function(evt) {
                      ...
                      if (evt.getEventName() == 'rotate') {
                        ...
                        if (this.binlogName !== evt.binlogName) {
